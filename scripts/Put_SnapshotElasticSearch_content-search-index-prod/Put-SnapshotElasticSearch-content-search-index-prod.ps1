...
$uri = "https://vpc-search-prod-uznvzxcraq7xcx55rwtpunmesq.us-west-2.es.amazonaws.com/_snapshot/vizio-prod-elasticsearch-backups/$TodaysDate-vizio-content-search-index-prod"
...
$body = @{
  "indices"              = "vizio-content-search-index-prod"
